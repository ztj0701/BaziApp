...
# --- 重要提示 ---
# 请确保以下文件与 bazi.py 和 app.py 在同一个目录下
from datas import *
...
# ==============================================================================
#  ★★★ 主要改动部分 ★★★
#  我们将所有核心逻辑封装到这个 bazi_main 函数中
# ==============================================================================
def bazi_main(year, month, day, time, is_gregorian=True, is_leap=False, is_female=False):
    """
    这是封装后的八字计算主函数。
    它接收所有必要的参数，并执行原始脚本中的所有 print 语句。
    """
    # 为了兼容原始代码，我们模拟一个 options 对象
    class Options:
        pass
    ...
    # 定义全局变量，因为原始代码中很多计算依赖它们
    global gans, zhis, me, zhus
    ...
    # ==============================================================================
    #  ↓↓↓ 从这里开始，是您原始文件中未经修改的全部核心计算和 print 逻辑 ↓↓↓
    # ==============================================================================
...
if __name__ == '__main__':
    # 这部分代码只有在 `python bazi.py ...` 这样直接运行时才会执行
    description = ''''''
    ...
    # 调用我们封装好的主函数
    bazi_main(
        year=cli_options.year,
        month=cli_options.month,
        day=cli_options.day,
        time=cli_options.time,
        is_gregorian=cli_options.g,
        is_leap=cli_options.r,
        is_female=cli_options.n
    )
